...
public class UserDAOImpl implements UserDAO {
    ...
    public boolean save(User entity) throws SQLException, ClassNotFoundException {
        return SQLUtil.execute("INSERT INTO user VALUES (?,?,?,?,?,?)", entity.getUserId(), entity.getFirstName(), entity.getLastName(), entity.getUsername(), entity.getEmail(), entity.getPassword());
    }
    ...
    public boolean isEmailExists(String email) throws SQLException, ClassNotFoundException {
        ResultSet rs = SQLUtil.execute("SELECT email FROM user WHERE email = ?", email);
        return rs.next();
    }

    public boolean update(User entity) throws SQLException, ClassNotFoundException {
        return SQLUtil.execute("UPDATE user SET first_name = ?, last_name = ?, username = ?, email = ?, password = ? WHERE user_id = ?", entity.getFirstName(), entity.getLastName(), entity.getUsername(), entity.getEmail(), entity.getPassword(), entity.getUserId());
    }
